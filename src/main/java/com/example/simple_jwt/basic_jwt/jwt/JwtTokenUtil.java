...
public class JwtTokenUtil {
        ...
        public static boolean validateTokenExceptExpiration(String tokenType, String jwtToken) {
                try {
                        Jws<Claims> claims = Jwts.parser().setSigningKey(tokenType).parseClaimsJws(jwtToken);
